...
if("TRUE" STREQUAL "TRUE")
  set(um6_SOURCE_PREFIX /home/lukewen/heron_ws/src/um6)
  set(um6_DEVEL_PREFIX /home/lukewen/heron_ws/devel)
  set(um6_INSTALL_PREFIX "")
  set(um6_PREFIX ${um6_DEVEL_PREFIX})
else()
  set(um6_SOURCE_PREFIX "")
  set(um6_DEVEL_PREFIX "")
  set(um6_INSTALL_PREFIX /home/lukewen/heron_ws/install)
...
if(NOT "/home/lukewen/heron_ws/devel/include;/home/lukewen/heron_ws/src/um6/include" STREQUAL "")
  set(um6_INCLUDE_DIRS "")
  set(_include_dirs "/home/lukewen/heron_ws/devel/include;/home/lukewen/heron_ws/src/um6/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'um6' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'um6' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lukewen/heron_ws/src/um6/${idir}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
    endif()
...
set(um6_EXPORTED_TARGETS "um6_generate_messages_cpp;um6_generate_messages_lisp;um6_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${um6_dep}_FOUND)
      find_package(${um6_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${um6_dep} REQUIRED ${depend_list})
  endif()
