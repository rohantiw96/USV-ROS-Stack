...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'ntu10_heron' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lukewen/heron_ws/install/${idir}'.  Ask the maintainer 'Clearpath Team <code@clearpathrobotics.com>' to fix it.")
    endif()
